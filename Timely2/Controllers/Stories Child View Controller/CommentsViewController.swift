...
class CommentsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let parentType = parentType {
            ...
            case .stories:
                NotificationCenter.default.addObserver(self,
                                                       selector: #selector(tabBarTapped),
                                                       name: .tabBarStoriesTapped,
                                                       object: nil
                )
            case .bookmarks:
                NotificationCenter.default.addObserver(self,
                                                       selector: #selector(tabBarTapped),
                                                       name: .tabBarBookmarksTapped,
                                                       object: nil
                )
            case .history:
                NotificationCenter.default.addObserver(self,
                                                       selector: #selector(tabBarTapped),
                                                       name: .tabBarHistoryTapped,
                                                       object: nil
                )
            }
        }
    ...
    @objc private func tabBarTapped(_ notification: Notification) {
